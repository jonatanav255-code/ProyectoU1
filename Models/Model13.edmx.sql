...
-- --------------------------------------------------
-- Date Created: 04/14/2020 20:04:10
...
GO
IF OBJECT_ID(N'[dbo].[FK_Fotografia_Id]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Incendias] DROP CONSTRAINT [FK_Fotografia_Id];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Fotografia]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Fotografia];
GO
...
CREATE TABLE [dbo].[Incendias] (
    ...
    [Fotografia_Id] smallint  NOT NULL,
    [Estado_Incidencias_Id] smallint  NOT NULL,
    [usuario_id] smallint  NOT NULL
);
GO

-- Creating table 'Fotografia'
CREATE TABLE [dbo].[Fotografia] (
    [Id_Fotografia] smallint IDENTITY(1,1) NOT NULL,
...
-- Creating primary key on [Id_Fotografia] in table 'Fotografia'
ALTER TABLE [dbo].[Fotografia]
ADD CONSTRAINT [PK_Fotografia]
    PRIMARY KEY CLUSTERED ([Id_Fotografia] ASC);
GO
...
-- Creating foreign key on [Fotografia_Id] in table 'Incendias'
ALTER TABLE [dbo].[Incendias]
ADD CONSTRAINT [FK_Fotografia_Id]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Fotografia_Id'
CREATE INDEX [IX_FK_Fotografia_Id]
ON [dbo].[Incendias]
    ([Fotografia_Id]);
GO
